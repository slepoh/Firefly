...
export const site = {
  ...
  url: "https://823331.xyz",
  avatar: "https://assets.823331.xyz/images/avatar.webp",
  email: "slepoh@aioky.cn",
};

{/* ========= 注意事项 ========== */}

export const notes = [
  { title: "互换原则", content: "请先在您的站点添加本站友链，确认无误后我们将尽快添加贵站友链。" },
  { title: "链接维护", content: "若友链站点长期无法访问或存在违规内容，我们将及时移除该链接。" },
  { title: "内容要求", content: "内容积极健康，不得含有任何色情、反动、暴力等违法违规信息。" },
  { title: "站点要求", content: "需支持 HTTPS，以原创内容为主，且可稳定访问、保持持续更新。" },
];
